...
fxn_navsetCardTabTitle <- 
  function(azmetStation, navsetCardTabTitleIcon) {
        ...
        htmltools::HTML(
          paste0(
            ...
            bslib::tooltip(
              ...
              "In addition to the following summary, select from the tabs below to view the calculated accumulation in different contexts.",
